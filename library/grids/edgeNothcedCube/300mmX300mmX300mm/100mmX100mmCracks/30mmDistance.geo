...
// global dimensions
L  = 300.0;   // total length  (x direction)
W  = 300.0;   // total width   (y direction)
H  = 300.0;   // total height  (z direction)

// crack-plan sizes in top view
L1 = 100;    // x-size of C1 patch from left boundary
L2 = 100;    // x-size of C2 patch from right boundary
W1 = 100;    // y-size of C1 patch from top boundary
W2 = 100;    // y-size of C2 patch from bottom boundary

// crack heights in front view
// Note: H1 should be smaller than or or equal to H2. If it doesn't, the order between the given heights will be swapped.
...
H1 = 165;    // height of C1 crack
H2 = 135;    // height of C2 crack
...
lc = 14.5; // the size for elements

pre_refinement_factor_z = 5.2;
